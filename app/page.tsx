...
export default function Home() {
  return (
    <main className="flex justify-between items-start gap-8">
      ...
      <div className="flex-1 bg-white rounded-[31px] p-6">
        <div className="flex justify-between items-center gap-2">
          <p className="text-black font-medium text-xl">Waiting on Retainer</p>
          <div className="bg-[#F8F8F8] w-12 h-11 rounded-[21px] flex justify-center items-center text-black font-medium text-xl">
            34
          </div>
        </div>
      ...
      <button className="w-56 font-medium h-[88px] flex justify-center shadow-homeBtnShadow items-center gap-2 bg-black fixed right-8 bottom-4 rounded-full text-white text-xl">
